	...
	XMMATRIX baseViewMatrix)
{
	...
	result = m_Font->Initialize(device, deviceContext,"..\\Data\\fontdata.txt", "..\\Data\\font.tga");
	if (!result)
	{
...
bool TextClass::UpdateSentence(SentenceType* sentence, char const* text, int positionX, int positionY, float red, float green, float blue,
	ID3D11DeviceContext* deviceContext)
{
	...
	m_Font->BuildVertexArray((void*)vertices, text, drawX, drawY);// Lock the vertex buffer so it can be written to.
